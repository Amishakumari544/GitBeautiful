...
const Sidebar = () => {
    return (
        <div className="bg-pink-50  p-4 md:h-screen h-full">


            <div className="bg-white p-4 flex items-center rounded-xl shadow-sm">
                <span className="bg-pink-100 p-2 text-2xl rounded-xl mr-2">🚀</span>
                <div>
            ...
            <div className="flex  flex-col justify-center my-4 bg-white rounded-xl shadow-sm">
                ...
                <NavLink to="/" >
                    <div className="transform hover:scale-105 hover:bg-pink-50 duration-100 p-4 flex rounded-xl items-center bg-white ">
                ...
                <NavLink to="/dev" activeClassName='border rounded-xl'>
                    <div className=" transform hover:scale-105 hover:bg-pink-50 duration-100 p-4  flex items-center rounded-xl bg-white   ">
                ...
                <NavLink to="/techcrunch" activeClassName='border rounded-xl'>
                    <div className="transform hover:scale-105 hover:bg-pink-50 duration-100 flex p-4 items-center  rounded-xl bg-white  ">
            ...
            <div className=" text-gray-400 flex flex-row justify-evenly">
                <a href="https://github.com/Amishakumari544/bloghouse" target="_blank" rel="noreferrer" className="flex">
